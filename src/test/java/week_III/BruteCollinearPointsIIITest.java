...
class BruteCollinearPointsIIITest {
    ...
    public void shouldReturnCollinearPointsForOneMatchingLineSegment() {
       ...
       final BruteCollinearPointsIII bruteCollinearPointsIII = new BruteCollinearPointsIII(points);

       assertThat(bruteCollinearPointsIII.numberOfSegments(), is(1));

       assertThat(bruteCollinearPointsIII.segments()[0].toString(), equalTo(new LineSegment(expectedPoint1, expectedPoint2).toString()));
    }
    ...
    public void shouldReturnCollinearPointsForTwoMatchingLineSegment() {
        ...
        assertThat(BruteCollinearPointsIII.numberOfSegments(), is(2));
        ...
        assertThat(BruteCollinearPointsIII.segments()[0].toString(), equalTo(lineSegment1.toString()));
        assertThat(BruteCollinearPointsIII.segments()[1].toString(), equalTo(lineSegment2.toString()));
    }
    ...
    public void shouldReturnCollinearPointsForTwoMatchingLineSegmentRandomSetUp() {
        ...
        final LineSegment lineSegment1 = new LineSegment(expectedPoint1, expectedPoint2);
        final LineSegment lineSegment2 = new LineSegment(expectedPoint3, expectedPoint4);
        final LineSegment[] segments = BruteCollinearPointsIII.segments();
    ...
    void shouldGetOriginalIndex() {
        ...
        final BruteCollinearPointsIII collinearPoints = new BruteCollinearPointsIII(new Point[] {new Point(1, 2)});
...
//
    ...
    @Test
    public void shouldReturnCollinearPointsForTwoDuplicateMatchingLineSegment() {
        ...
        final BruteCollinearPointsIII bruteCollinearPoints = new BruteCollinearPointsIII(points);
